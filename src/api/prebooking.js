...
const get = (prebookingNumber, accessToken) => {
    return new Promise((resolve, reject) => {
        axios({
            method: 'post',
...
const approve = (prebookingNumber, accessToken) => {
    return new Promise((resolve, reject) => {
        axios({
            method: 'post',
...
const cancel = (prebookingNumber, accessToken) => {
    return new Promise((resolve, reject) => {
        axios({
            method: 'post',
...
module.exports = { book, get, approve, cancel };