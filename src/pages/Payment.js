                            ...
                            <div className="col-12 mb-4">
                                <div className="row box-right">
                                    <div className="col-md-8 ps-0 ">
                                        ...
                                        <p className="h1 fw-bold d-flex mt-3"> <span className=" fas fa-dollar-sign textmuted pe-1 h6 align-text-top mt-1" />{props.totalPrice}</p>
                                    </div>
                            ...
                            <div className="h8">
                                <div className="row m-0 border mb-3">
                                    ...
                                    <div className="col-2 p-0 text-center h8 border-end">
                                        ...
                                        <span className="d-block border-bottom py-2"><span className="fas fa-dollar-sign" />{props.price}</span>
                                    </div>
                                    <div className="col-2 p-0 text-center">
                                        <p className="textmuted p-2">Total</p>
                                        <span className="d-block py-2 border-bottom"><span className="fas fa-dollar-sign" />{props.totalPrice}</span>
                                    </div>
                                </div>
                                <div className="d-flex h7 mb-2">
                                    <p className>Total Amount</p>
                                    <p className="ms-auto"><span className="fas fa-dollar-sign" />{props.totalPrice}</p>
                                </div>
                                ...
                                <div className="form">
                                    <div className="row">
                                        <div className="col-12">
                                            <div className="card border-0"> <input className="form-control ps-5" type="text" placeholder="Card number" /> <span className="far fa-credit-card" /> </div>
                                        </div>
                                    ...
                                    <div className="btn btn-primary d-block h8" onClick={props.onPayment}>PAY <span className="fas fa-dollar-sign ms-2" />{props.totalPrice}<span className="ms-3 fas fa-arrow-right" /></div>
                                </div>
                            </div>
                        </div>
                    </div>
